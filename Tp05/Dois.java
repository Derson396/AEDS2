...
class ArvoreBinaria {
    ...
    private No pesquisar3(String x, No i) {
        No resp;
        if (i == null) {
            resp = null;
        } else if (x.charAt(0) < i.elemento) {
            resp = pesquisar3(x, i.esq);
        } else if (x.charAt(0) == i.elemento) {
            resp = i;
        } else {
            resp = pesquisar3(x, i.dir);
        }
        return resp;
    }
     ...
     */
    public void inserir2(String x) {
        No resp = pesquisar3(x, raiz);
        resp.sub = inserir2(x, resp.sub);
    }
    ...
    private No2 inserir2(String x, No2 i) {
        if (i == null) {
            ...
            i.left = inserir2(x, i.left);

        } else if (x.compareTo(i.elemento) > 0) {
            i.right = inserir2(x, i.right);
     ...
     * @ Se nao encontrar elemento.
     */
    private No2 remover(String x, No2 i) {
...
class No {
    ...
    public No(char elemento, No esq, No dir, No2 sub) {
        this.elemento = elemento;
        this.esq = esq;
        this.dir = dir;
        this.sub = sub;
...
class No2 {
    ...
    public No2 left, right;

    public No2(String elemento) {
        this(elemento, null, null);
    }

    public No2(String elemento, No2 left, No2 right) {
        this.elemento = elemento;
        this.left = left;
        this.right = right;
    }
