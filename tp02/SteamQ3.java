...
class SteamQ3 {
    ...
    public SteamQ3(String id) {
        this.app_id = Integer.parseInt(id);
    }
    public SteamQ3(String nome,int aleatorio)
    {
        this.name=nome;
    }
    ...
    public SteamQ3(int app_id, int age, int dlcs, int avg_pt, float price, float upvotes, String name, String owners,
    ...
    public SteamQ3 clone(SteamQ3 clone) {
        return (new SteamQ3(clone.age, clone.app_id, clone.avg_pt, clone.dlcs, clone.price, clone.upvotes,
        ...
        while (!isFim(entrada)) {
            try {
                ...
                while ((strCurrentLine = leitorObj.readLine()) != null) {
                    ...
                    SteamQ3 joguim = new SteamQ3(id[0]);
                    if (id[0].equals(entrada)) {
                        joguim.leitura(strCurrentLine);
