...
public class One {
    public static void main(String args[]) {
        ...
        while (count > 0) {
            ...
            Game jogo = new Game();
            if (input01.equals("II")) {
                input01 = MyIO.readLine();
                jogo.readClass(input01, "/tmp/games.csv");
                listinha.inserirInicio(jogo);
            }
            if (input01.equals("IF")) {
                input01 = MyIO.readLine();
                jogo.readClass(input01, "/tmp/games.csv");
                listinha.inserirFim(jogo);
            }
            if (input01.equals("I*")) {
                ...
                input01 = MyIO.readLine();
                jogo.readClass(input01, "/tmp/games.csv");
                listinha.inserir(jogo, pos);
            }
            if (input01.equals("RF")) {
                System.out.println("(R) " + listinha.removerFim());
            }
            if (input01.equals("RI")) {
                System.out.println("(R) " + listinha.removerInicio());
            }
            if (input01.equals("R*")) {
                pos = MyIO.readInt();
                System.out.println("(R) " + listinha.remover(pos));
            }
            count--;
        }
        int i = 0;
        for (Game aux = listinha.primeiro.prox; aux != null; aux = aux.prox) {
            aux.imprimir(i++);
        }
    }
}
